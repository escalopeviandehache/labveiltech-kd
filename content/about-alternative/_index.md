...
Actuellement en **Bachelor of Science en Ingénierie des Médias** à la HEIG-VD, je suis un créatif passionné par l'alliance entre technologie, design et communication. Mon objectif est de concevoir des expériences numériques qui font sens, tout en restant à la pointe des outils de création moderne.

## Mon Expertise

Mon parcours académique et mes distinctions m'ont permis de développer une expertise solide dans :

- **Conception & Design** — Maîtrise avancée de Figma, Adobe Creative Cloud (Illustrator, InDesign, Premiere Pro) et Canva.
- **Développement Web** — Expérience avec WordPress, Wix, Framer et des notions poussées en SEO et Google Analytics.
- **Stratégie Digitale** — Gestion de réseaux sociaux et marketing acquise lors de mes immersions professionnelles.
- **Innovation** — Capacité à livrer des projets de haute qualité sous pression, comme démontré lors de hackathons.

## Distinctions Récentes

Je suis fier d'avoir obtenu plusieurs reconnaissances majeures pour mon travail :
- **Meilleur projet (6/6)** — Mandat Breitling x HEIG-VD (2025).
...
<div style="margin-top: 10px;">
    <a href="../../theme/minimal-black/static/images/Ikigai-kd.png" target="_blank" style="font-size: 0.9em; text-decoration: underline; color: black; background-color: #E6B3FF; padding: 2px 4px; border-radius: 3px;">
...
**Bachelor en Ingénierie des Médias** — [HEIG-VD](https://heig-vd.ch)
*2023 – 2026 (En cours) • Yverdon-Les-Bains* 

Formation approfondie sur la gestion de projets média, le développement web et le design interactif.

---

**Maturité Spécialisée en Ingénierie des Médias** — [ERACOM](https://eracom.ch)
*2022 – 2023 • Lausanne* 

Spécialisation technique avant l'entrée en école d'ingénieurs.

---

**Certificat d'ECG en option Communication et Information** — [Gymnase de Morges](https://www.gymnasedemorges.ch)
*2019 – 2022 • Morges*

Obtention du certificat avec un focus sur les mécanismes de l'information. 
